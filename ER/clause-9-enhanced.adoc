...
image::images/Polymorphism.png[width=400]
...
image::images/Profiles.png[width=400]
...
image::images/Dimensions.png[width=400]
...
Nesting of datacubes may be done virtually...

[[img_Geofederation]]
.Geofederation - a typical "virtual nesting" of datacubes
image::images/Geofederation.png[width=400]

[[img_Brokering]]
.Semantics enabled brokering of datasets using dimension relationships
image::images/QB_brokering.png[width=400]
