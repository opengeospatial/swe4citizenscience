...
.[big]*Abstract*
This discussion paper is a result of the research project https://cobwebproject.eu[Citizen Observatory Web (COBWEB)]. COBWEB is supported by the European Commission through grant agreement 308513. The discussion paper describes a data model for the standardized exchange of citizen science sampling data.
