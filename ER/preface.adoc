...
.[big]*Abstract*
This discussion paper is a result of the research project https://cobwebproject.eu[Citizen Observatory Web (COBWEB)]. COBWEB is supported by the European Commission through grant agreement 308513.

.[big]*Business Value*
This discussion paper outlines a data model for citizen science data and outlines a future interoperability approach based on semantic web concepts.


.[big]*What does this ER mean for the Working Group and OGC in general*
This discussion paper should be considered by the Citizen Science Domain Working Group
